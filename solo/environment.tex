...
Once an environment exists on the server, a node can be associated with that environment using the \inline{chef_environment} method of <<node>> object in Ruby.
