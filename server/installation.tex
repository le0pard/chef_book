...
In most cases web interface gives information about your cloud, which you can get from knife tool. That is why generally it is disabled by attribute <<chef-server-webui.enable = false>>.
