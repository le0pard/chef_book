...
where \inline!t.updated_by_last_action?! uses a variable to check whether a new crontab entry was created. Also you should remember that \inline!t.updated_by_last_action?! will work only with \inline!run_action!, without it this method will return always false.
