...
\begin{itemize}
  \item \inline!namecollect_data()! blocks, which enable better organization of platform-specific code
  \item \inline!depends! / \inline!provides! statements, which enable easier dependency management among plugins
\end{itemize}
