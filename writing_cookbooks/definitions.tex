...
In our \lstinline!my_cool_app! cookbook we are using \lstinline!nginx_site! definition from nginx cookbook.
...
Let's create definition in our \lstinline!my_cool_app! cookbook. We will move our nginx conf creation into definition. Our code:
...
we moved to definition \lstinline!enable_web_site!:
...
And now we can replace code in~\ref{lst:cookbook-definitions-default1} by call of \lstinline!enable_web_site!:
