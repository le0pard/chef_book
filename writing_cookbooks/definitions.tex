...
\begin{lstlisting}[label=lst:cookbook-definitions1]
...
\begin{lstlisting}[label=lst:cookbook-definitions2]
...
\begin{lstlisting}[label=lst:cookbook-definitions3]
# enable website
...
\begin{lstlisting}[language=Bash,label=lst:cookbook-definitions4]
